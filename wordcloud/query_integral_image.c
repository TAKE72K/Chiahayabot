...
{
    "distutils": {
        "name": "telegrambot.wordcloud.query_integral_image",
        "sources": [
            "query_integral_image.pyx"
        ]
    },
    "module_name": "telegrambot.wordcloud.query_integral_image"
}
END: Cython Metadata */
...
#define __PYX_HAVE__telegrambot__wordcloud__query_integral_image
#define __PYX_HAVE_API__telegrambot__wordcloud__query_integral_image
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'telegrambot.wordcloud.query_integral_image' */
...
#define __Pyx_MODULE_NAME "telegrambot.wordcloud.query_integral_image"
extern int __pyx_module_is_main_telegrambot__wordcloud__query_integral_image;
int __pyx_module_is_main_telegrambot__wordcloud__query_integral_image = 0;

/* Implementation of 'telegrambot.wordcloud.query_integral_image' */
...
static const char __pyx_k_telegrambot_wordcloud_query_inte[] = "telegrambot.wordcloud.query_integral_image";
...
static PyObject *__pyx_n_s_telegrambot_wordcloud_query_inte;
...
static PyObject *__pyx_pf_11telegrambot_9wordcloud_20query_integral_image_query_integral_image(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_integral_image, int __pyx_v_size_x, int __pyx_v_size_y, PyObject *__pyx_v_random_state); /* proto */
...
/* "telegrambot/wordcloud/query_integral_image.pyx":7
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_11telegrambot_9wordcloud_20query_integral_image_1query_integral_image(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_11telegrambot_9wordcloud_20query_integral_image_1query_integral_image = {"query_integral_image", (PyCFunction)__pyx_pw_11telegrambot_9wordcloud_20query_integral_image_1query_integral_image, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_11telegrambot_9wordcloud_20query_integral_image_1query_integral_image(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("telegrambot.wordcloud.query_integral_image.query_integral_image", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11telegrambot_9wordcloud_20query_integral_image_query_integral_image(__pyx_self, __pyx_v_integral_image, __pyx_v_size_x, __pyx_v_size_y, __pyx_v_random_state);
...
static PyObject *__pyx_pf_11telegrambot_9wordcloud_20query_integral_image_query_integral_image(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_integral_image, int __pyx_v_size_x, int __pyx_v_size_y, PyObject *__pyx_v_random_state) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_area;
  int __pyx_v_i;
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":9
 * def query_integral_image(unsigned int[:,:] integral_image, int size_x, int
 *                          size_y, random_state):
 *     cdef int x = integral_image.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":10
 *                          size_y, random_state):
 *     cdef int x = integral_image.shape[0]
 *     cdef int y = integral_image.shape[1]             # <<<<<<<<<<<<<<
 *     cdef int area, i, j
 ...
 */
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":12
 *     cdef int y = integral_image.shape[1]
 *     cdef int area, i, j
 *     cdef int hits = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":15
 * 
 *     # count how many possible locations
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "telegrambot/wordcloud/query_integral_image.pyx":16
 *     # count how many possible locations
 *     for i in xrange(x - size_x):
 *         for j in xrange(y - size_y):             # <<<<<<<<<<<<<<
 *             area = integral_image[i, j] + integral_image[i + size_x, j + size_y]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "telegrambot/wordcloud/query_integral_image.pyx":17
 *     for i in xrange(x - size_x):
 *         for j in xrange(y - size_y):
 *             area = integral_image[i, j] + integral_image[i + size_x, j + size_y]             # <<<<<<<<<<<<<<
 *             area -= integral_image[i + size_x, j] + integral_image[i, j + size_y]
 ...
 */
      ...
      /* "telegrambot/wordcloud/query_integral_image.pyx":18
 *         for j in xrange(y - size_y):
 *             area = integral_image[i, j] + integral_image[i + size_x, j + size_y]
 *             area -= integral_image[i + size_x, j] + integral_image[i, j + size_y]             # <<<<<<<<<<<<<<
 *             if not area:
 ...
 */
      ...
      /* "telegrambot/wordcloud/query_integral_image.pyx":19
 *             area = integral_image[i, j] + integral_image[i + size_x, j + size_y]
 *             area -= integral_image[i + size_x, j] + integral_image[i, j + size_y]
 *             if not area:             # <<<<<<<<<<<<<<
 *                 hits += 1
 ...
 */
      ...
      if (__pyx_t_15) {
        ...
        /* "telegrambot/wordcloud/query_integral_image.pyx":20
 *             area -= integral_image[i + size_x, j] + integral_image[i, j + size_y]
 *             if not area:
 *                 hits += 1             # <<<<<<<<<<<<<<
 *     if not hits:
 ...
 */
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":21
 *             if not area:
 *                 hits += 1
 *     if not hits:             # <<<<<<<<<<<<<<
 *         # no room left
 ...
 */
  ...
  if (__pyx_t_15) {
    ...
    /* "telegrambot/wordcloud/query_integral_image.pyx":23
 *     if not hits:
 *         # no room left
 *         return None             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":25
 *         return None
 *     # pick a location at random
 *     cdef int goal = random_state.randint(0, hits)             # <<<<<<<<<<<<<<
 *     hits = 0
 ...
 */
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":26
 *     # pick a location at random
 *     cdef int goal = random_state.randint(0, hits)
 *     hits = 0             # <<<<<<<<<<<<<<
 *     for i in xrange(x - size_x):
 ...
 */
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":27
 *     cdef int goal = random_state.randint(0, hits)
 *     hits = 0
 *     for i in xrange(x - size_x):             # <<<<<<<<<<<<<<
 *         for j in xrange(y - size_y):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "telegrambot/wordcloud/query_integral_image.pyx":28
 *     hits = 0
 *     for i in xrange(x - size_x):
 *         for j in xrange(y - size_y):             # <<<<<<<<<<<<<<
 *             area = integral_image[i, j] + integral_image[i + size_x, j + size_y]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "telegrambot/wordcloud/query_integral_image.pyx":29
 *     for i in xrange(x - size_x):
 *         for j in xrange(y - size_y):
 *             area = integral_image[i, j] + integral_image[i + size_x, j + size_y]             # <<<<<<<<<<<<<<
 *             area -= integral_image[i + size_x, j] + integral_image[i, j + size_y]
 ...
 */
      ...
      /* "telegrambot/wordcloud/query_integral_image.pyx":30
 *         for j in xrange(y - size_y):
 *             area = integral_image[i, j] + integral_image[i + size_x, j + size_y]
 *             area -= integral_image[i + size_x, j] + integral_image[i, j + size_y]             # <<<<<<<<<<<<<<
 *             if not area:
 ...
 */
      ...
      /* "telegrambot/wordcloud/query_integral_image.pyx":31
 *             area = integral_image[i, j] + integral_image[i + size_x, j + size_y]
 *             area -= integral_image[i + size_x, j] + integral_image[i, j + size_y]
 *             if not area:             # <<<<<<<<<<<<<<
 *                 hits += 1
 ...
 */
      ...
      if (__pyx_t_15) {
        ...
        /* "telegrambot/wordcloud/query_integral_image.pyx":32
 *             area -= integral_image[i + size_x, j] + integral_image[i, j + size_y]
 *             if not area:
 *                 hits += 1             # <<<<<<<<<<<<<<
 *                 if hits == goal:
 ...
 */
        ...
        /* "telegrambot/wordcloud/query_integral_image.pyx":33
 *             if not area:
 *                 hits += 1
 *                 if hits == goal:             # <<<<<<<<<<<<<<
 *                     return i, j
 */
        ...
        if (__pyx_t_15) {
          ...
          /* "telegrambot/wordcloud/query_integral_image.pyx":34
 *                 hits += 1
 *                 if hits == goal:
 *                     return i, j             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "telegrambot.wordcloud.query_integral_image.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "telegrambot.wordcloud.query_integral_image.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "telegrambot.wordcloud.query_integral_image.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "telegrambot.wordcloud.query_integral_image._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_telegrambot_wordcloud_query_inte, __pyx_k_telegrambot_wordcloud_query_inte, sizeof(__pyx_k_telegrambot_wordcloud_query_inte), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_telegrambot__wordcloud__query_integral_image) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "telegrambot.wordcloud.query_integral_image")) {
      if (unlikely(PyDict_SetItemString(modules, "telegrambot.wordcloud.query_integral_image", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":3
 ...
 */
  ...
  /* "telegrambot/wordcloud/query_integral_image.pyx":4
 * # cython: wraparound=False
 * import array
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 *     cdef int x = integral_image.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_11telegrambot_9wordcloud_20query_integral_image_1query_integral_image, NULL, __pyx_n_s_telegrambot_wordcloud_query_inte); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_query_integral_image, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "telegrambot/wordcloud/query_integral_image.pyx":1
 * # cython: boundscheck=False             # <<<<<<<<<<<<<<
 * # cython: wraparound=False
 * import array
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init telegrambot.wordcloud.query_integral_image", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init telegrambot.wordcloud.query_integral_image");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
